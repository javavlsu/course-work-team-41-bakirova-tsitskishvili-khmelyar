...
public class TeacherStudentGradeItem {
    ...
    public int getQuarterFinalGrade() {
        return quarterFinalGrade;
    }

    public void setQuarterFinalGrade(int quarterFinalGrade) {
        this.quarterFinalGrade = quarterFinalGrade;
    }
    ...
    public int getAbsentTypeH() {
        return absentTypeH;
    }

    public void setAbsentTypeH(int absentTypeH) {
        this.absentTypeH = absentTypeH;
    }

    public int getAbsentTypeU() {
        return absentTypeU;
    }

    public void setAbsentTypeU(int absentTypeU) {
        this.absentTypeU = absentTypeU;
    }

    public int getAbsentTypeB() {
        return absentTypeB;
    }

    public void setAbsentTypeB(int absentTypeB) {
        this.absentTypeB = absentTypeB;
    }

    public int getTotalLessonsInPeriod() {
        return totalLessonsInPeriod;
    }

    public void setTotalLessonsInPeriod(int totalLessonsInPeriod) {
        this.totalLessonsInPeriod = totalLessonsInPeriod;
    }
    ...
    public double getPercent5() {
        return getGradeCount() > 0 ? (getGradeCount5() * 100.0 / getGradeCount()) : 0;
    }

    public double getPercent4() {
        return getGradeCount() > 0 ? (getGradeCount4() * 100.0 / getGradeCount()) : 0;
    }

    public double getPercent3() {
        return getGradeCount() > 0 ? (getGradeCount3() * 100.0 / getGradeCount()) : 0;
    }

    public double getPercent2() {
        return getGradeCount() > 0 ? (getGradeCount2() * 100.0 / getGradeCount()) : 0;
    }

    public double getPercent1() {
        return getGradeCount() > 0 ? (getGradeCount1() * 100.0 / getGradeCount()) : 0;
    }
}