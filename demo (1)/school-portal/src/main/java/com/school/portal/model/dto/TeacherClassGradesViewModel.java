...
public class TeacherClassGradesViewModel {
    ...
    public List<TeacherStudentGradeItem> getStudents() {
        return students;
    }

    public void setStudents(List<TeacherStudentGradeItem> students) {
        this.students = students;
    }

    public Map<Integer, String> getAvailableClasses() {
        return availableClasses;
    }

    public void setAvailableClasses(Map<Integer, String> availableClasses) {
        this.availableClasses = availableClasses;
    }

    public Map<Integer, String> getAvailableSubjects() {
        return availableSubjects;
    }

    public void setAvailableSubjects(Map<Integer, String> availableSubjects) {
    ...
    public void setAvailableQuarters(List<String> availableQuarters) {
