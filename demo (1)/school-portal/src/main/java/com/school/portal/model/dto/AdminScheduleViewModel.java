...
public class AdminScheduleViewModel {
    ...
    public void setAvailableTeachers(List<User> availableTeachers) {
    ...
    public void setAvailableClasses(List<SchoolClass> availableClasses) {
        this.availableClasses = availableClasses;
    }

    public Map<DayOfWeek, List<AdminScheduleItemViewModel>> getScheduleByDay() {
        return scheduleByDay;
    }

    public void setScheduleByDay(Map<DayOfWeek, List<AdminScheduleItemViewModel>> scheduleByDay) {
